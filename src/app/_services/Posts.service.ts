...
export class PostsService {
    ...
    constructor() {
        this.data = [
            ...
            { id: 4,title:"How to Survive Giving Your Dog a Bath",body:"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.",userId:2,TagsId:[1,2],image:"../../../../assets/images/blog/adorable-animals-breed-374825.jpg",time:'10:00pm',day:"",month:"DEC",year:"2013"},
        ]
    }
    getAll(): Post[] {
        return this.data;
