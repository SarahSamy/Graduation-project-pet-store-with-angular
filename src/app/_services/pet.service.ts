...
export class PetService {
    ...
    constructor() {
        this.data = [
            ...
            { id: 2, name: "Bossy", image: "assets/images/cat1.jpg", gender: "female", isAdapt: true, age: 2, category: { id: 2, name: "Classic Persian", typeId: 1, type: { id: 1, name: "Cat" } }, views: 5 },
            ...
            { id: 9, name: "Gamil", image: "assets/images/turtle.jpg", gender: "male", isAdapt: true, age: 2, category: { id: 12, name: " Eastern", typeId: 4, type: { id: 4, name: "Turtle" } }, views: 2 },
